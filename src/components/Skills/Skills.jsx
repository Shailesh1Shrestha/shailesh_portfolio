    ...
    <div className='lg:mx-12 mx-4 py-32' id = "skills">
      <div className = "text-headingColor mb-20">
        ...
        <div className='grid lg:gri-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-8 '>
            {
                skills.map(skill =>
                    <div key={skill.id} className="bg-bgShade p-8 rounded-lg cursor-pointer
                    hover:-translate-y-4 translition-all duration-300 skillcard">
                      <img src={skill.image} alt="img" className='w-20 h-20 bg-white rounded-lg shadow-md mb-7 p-3' />
